...
A lot of duplicate code could be not used if a flag could hold a 'reverse' condition, as using a 74HC74 D-flip-flop. But why do this ? The 2k eeprom already have plenny unused space, so let's make it in software. Vide [logic loops](https://github.com/agsb/jelly/blob/main/documents/LogicLoop.md).
